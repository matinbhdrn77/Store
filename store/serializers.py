...
from .signals import created_order
...
class CreateOrderSerializer(serializers.Serializer):
    ...
    def validate_cart_id(self, cart_id):
        if not Cart.objects.filter(pk=cart_id).exists():
            raise serializers.ValidationError("No cart with this given id")
        ...
        with transaction.atomic():
            ...
            order_items = [
                OrderItem(
                    ...
                    unit_price=item.product.unit_price, quantity=item.quantity
            ...
            created_order.send_robust(self.__class__, order=order)
